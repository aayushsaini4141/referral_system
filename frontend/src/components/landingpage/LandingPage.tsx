         ...
         {/* Hero Section */}
          ...
          <section className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-3xl font-bold text-center mb-16 text-black">How It Works</h2>
              <div className="grid md:grid-cols-3 gap-12">
                <div className="text-center">
                  <div className="bg-rose-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
                    <Share2 className="w-8 h-8 text-[#EC0B43]" />
                  </div>
                  <h3 className="text-xl font-semibold mb-4 text-black">Step 1: Refer Businesses</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-4 text-black">Step 2: Earn Commissions</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-4 text-black">Step 3: Weekly Payouts</h3>
          ...
          <section className="py-20 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-3xl font-bold text-center mb-16 text-black">Commission Structure</h2>
          ...
          <section className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-3xl font-bold text-center mb-16 text-black">Why Join the Ooulet Partner Program?</h2>
              <div className="grid md:grid-cols-3 gap-8">
                {benefits.map((benefit) => (
                  <div
                    key={benefit.title}
                    className="flex items-start space-x-4 p-6 bg-rose-50 rounded-lg text-black"
                  >
